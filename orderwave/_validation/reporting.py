...
def write_validation_summary(
    *,
    ...
    lines = [
        ...
        "",
        "## 1. 실험 설정",
        f"- profile: {acceptance.get('profile_name', 'quality_regression')}",
        ...
        f"- market-state stylized structure: `{pass_fail(acceptance['stylized_facts_ok'])}`",
    ...
    lines.extend(
        [
            ...
            "- 평가 관점: aggregate order-book market-state simulator",
